  ...
  return (
    <>
      <SeoMeta 
        ...
        canonicalUrl="https://casabrancareformas.com/sobre"
        ogTitle="Sobre a Casa Branca Reformas - 10 Anos em Ubatuba"
        ogDescription="Conheça a história de Elton 'Casabranca' e da empresa que atua há 10 anos em construção civil e reformas em Ubatuba."
        twitterTitle="Casa Branca Reformas - Nossa História"
        twitterDescription="10 anos transformando espaços em Ubatuba com excelência técnica e projetos personalizados."
        ogImage="/og-about.jpg"
        twitterImage="/twitter-about.jpg"
        ogImageAlt="Elton 'Casabranca' - Fundador da Casa Branca Reformas"
        localBusiness={true}
